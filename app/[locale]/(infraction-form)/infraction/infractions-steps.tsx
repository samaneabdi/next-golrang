    ...
    return(
        <section className="sm:flex sm:mt-14 mb-6 justify-center text-base">
            ...
            <Link href='/infraction' >
                <div className={`${pathname === '/infraction' ? 'step-processing':'step-tobe-process'} flex mt-4 sm:mt-0 items-center justify-between sm:w-auto w-4/5 mx-auto`}>
                    <span className={`${pathname === '/infraction' ? 'step-processing':'step-tobe-process'} steps material-symbols-outlined sm:ml-5 ml-2 relative p-1`}>Circle</span>
                    <p className="leading-10 ml-4 text-base font-medium">{t("infraction-step")}</p>
                    <hr className="sm:w-24 w-20 h-0.5 sm:ml-4 border-0 rounded"/>
                </div>
            </Link>
            <Link href="/tracking">
                <div className={`${pathname === '/tracking' ? 'step-processing':'step-tobe-process'} flex mt-4 sm:mt-0 items-center justify-between sm:w-auto w-4/5 mx-auto`}>
                    <span className={`${pathname === '/tracking' ? 'step-processing':'step-tobe-process'} steps material-symbols-outlined relative sm:ml-5 ml-3 p-1`}>Circle</span>
